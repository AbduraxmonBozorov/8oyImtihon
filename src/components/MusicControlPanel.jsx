...
import { setIsPlaying, setCurrentTrack, toggleShuffle, toggleRepeat, setVolume, setProgress } from '../redux/spotifySlice';
...
export default function MusicControlPanel() {
  ...
  const handleProgressChange = (e) => {
    if (audioRef.current) {
      ...
      dispatch(setProgress(Number(e.target.value)));
    }
  };
